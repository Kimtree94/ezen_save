...
function multiplyAll(a, b) {
	...
	for (let i = a; i <= b; i++) {
		//i는 a부터 b까지 1씩증가 반복
		result *= i//누적 곱//result += i //+=는 누적합계임 
	}//for end
...
console.log('최대값 구하기 결과 2: ' + max2(1, 2, 3, 4))
...
console.log('최대값 구하기 결과 3:[배열->매개변수1개] ' + max3([1, 2, 3, 4]))// 인수2개 : 배열 

console.log('최대값 구하기 결과3[숫자->매개변수4개] : ' + max3(1, 2, 3, 4))// 인수2개 : 
