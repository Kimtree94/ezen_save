...
/*
	자판기 프로그램
		1. 제품 : 콜라 , 환타 , 사이다
		2. 초기제고 :각 10개씩  [변수]
		3. 메뉴판에서 선택한 제품을 장바구니 담기 [변수]
			1. 선택한 제품의 재고가 0이면 '재고 없음' 출력 -> 나감
			2. 제품제고 를 1차감 -> 장바구니 제품의 1증가
			3. 장바구니에 출력
		4. 결제를 선택했을때 장바구니 현황 표시 결제[돈 입력]  -경우의수 4개-
		5. 결제예정인 금액보다 투입금액이 부족하면 결제취소 금액이 초과이면 잔돈
		[화면구현]
