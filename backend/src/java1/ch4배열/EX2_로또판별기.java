...
/*
	로또 판별기
		1. 구매번호 : 사용자에게 6개 수 입력 ->배열저장
			1. 1~45사이만 입력받기 아니면 재입력		2. 중복제거
			
		2. 추첨번호 : 컴퓨터 난수6개 생성 -> 배열저장
			1. 1~45사이 난수
...
public class EX2_로또판별기 {//class S
		...
		public static void main(String[] args) {//main S
			...
			int[] 구매번호 = new int[6];//int형 변수 6개를 저장할수 잇는 공간
			int[] 추첨번호 = new int[6];//int형 변수 6개를 저장할수 잇는 공간
			
			//1.사용자에게 입력받는다. [ 6번 ]
			
			for(int i=0;i<6;i++) { //i=인덱스 //i는 0부터 5까지 1씩 증가. //for1
				...
				for(int j=0;j<i;j++) {//for2
					if(구매번호[j]==구매번호[i]) { //만약에 j번째 인덱스의 값과 i번째 인덱스와 값과 같으면 
						System.out.println("안내)이미 선택된 번호입니다.");
						중복체크 = true;//중복을 찾아냄 
					}//if2 e
				}//for2 e
				if(중복체크){i--;continue;}//중복체크 변수가 true이면 재입력
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			System.out.println();	 
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			///////////////////////////////////4.구매번호,추첨번호 배열끼리 동일한 수 비교 출력.//////////////////////////////////
			// 각 i마다 j와 비교
		int 당첨개수=0;
		for(int i=0;i<구매번호.length;i++) {	//6회
			for(int j=0;j<추첨번호.length;j++) {	//6회 x 6회 ->36
				if(구매번호[i]==추첨번호[j]) {당첨개수++;}//i번째 인덱스와 j번째 인덱스의 값이 같으면 
			}//for E
		}//for E
		System.err.println("총 당첨 개수 :"+당첨개수+"개입니다.");
