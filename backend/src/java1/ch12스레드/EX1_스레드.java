...
public class EX1_스레드 {
		...
		public static void main(String[] args) { 
			...
			// 멀티스레드 : 코드 읽는 여러개의 흐름
			// main스레드 : main함수 시작될때 실행 ---> retunr 시 스레드 종료 
			...
			for(int i = 0 ; i<5;i++) {
				...
				try {
					...
					// Thread.sleep(밀리초) : 밀리초 만큼 현재 스레드 일시정지 / 밀리초 : 1000/1초
					// Thread : 현재 스레드 
			...
			//////////////////////////////////////////////////////////////////////////////////
			// 2.p526
			System.out.println("---구현객체 멀티스레드 시작---");
			...
			//3.p527 : 익명 구현 객체 - 1회용 [ 이름 없으니까 다른곳에서 호출 불가능 ]
