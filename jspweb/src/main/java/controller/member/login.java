...
public class login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * request.getParameter("mpassword"); //변수 2개라 dto 사용 안함 // dao 메소드 호출 int
		 * result= MemberDao.getInstance().login(mid, mpassword); // true 이면 index.jsp
		 * false 이면 login.jsp if(result) {response.sendRedirect("/jspweb/index.jsp");}
