...
public class RPG게임 {
   ...
   public static void main(String[] args) {
     ...
     int dm = 2; int ran = 0; int 전사스킬=0; int 마법사스킬=0; int 궁수스킬=0;
     ...
     if(exp == 20) {
        ...
        if( lv == 5 ) {
	        	...
	        	System.out.println("．\t 　 　 ∧ ∧ \r\n"
	        			...
	        			+ "\t　 　 　　i｜|\r\n"
	        			+ "\t　　　　 ━━");
	        	System.out.println("\tLV5 달성을 축하합니다 직업을 선택해주세요!");
	        	System.out.println("\t1.전사  2.마법사  3.궁수");int job=scanner.nextInt();
	        
		        	if(job==1) {
		        			
		        			System.out.println("\t당신은 전사를 선택하셨습니다 전직하시겠습니까?");
		        			System.out.println("\t획득내용 : 추가체력 = 5 , 전사 전용 스킬  ");
		        			System.out.println("\t1.전직한다  2.다시 생각해본다");int 전사=scanner.nextInt();
		        			if(전사==1) {
		        			System.out.println("\t∧,,∧ \r\n"
		        					+ "\t( 'ω' )つ \r\n"
		        					+ "\t（m9 ＼ \r\n"
	        			...
	        			System.out.println("\t1.전직한다  2.다시 생각해본다");int 궁수=scanner.nextInt();
	        			if(궁수==1) {
	        			...
	        			System.out.println("\t획득내용 : 추가체력 = 5 , 궁수 전용 스킬  ");
	        			System.out.println("\t1.전직한다  2.다시 생각해본다");int 마법사=scanner.nextInt();
	        			if(마법사==1) {
	        			...
	        			System.out.println("\t...Λ＿Λ\r\n"
		        				...
		        				+ "\t　　　　　　　　　　(¸.·´ °。   \r\n"
		        				+ "\t                                       *。💖¸.·*¨)");
		        		 마법사스킬 = (int)((Math.random()*5)+1);     
	        			 hp+=5;
	        			}//마법사 전직 if E 
		        	}//마법사 if E
		        	
	        	else {System.out.println("\t제발 리스트에서 선택해주세요");B_job=false;}
	        	}//Lv5 while E
        }//Lv5 if E
